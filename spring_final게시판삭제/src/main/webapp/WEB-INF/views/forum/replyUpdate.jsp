...
<div class="wrapper_div">
	...
	<div class="input_wrap">			
			...
			<div class="content_div">
				<h4>리뷰</h4>
				<textarea name="content">${replyInfo.forum_content}</textarea>
			</div>
			<div class="content_mk">
				<h4>작성자</h4>
				<input name="forum_mk">${replyInfo.forum_mk}</input>
			</div>
		</div>
...
$(document).ready(function(){
	...
	let forum_rating = '${replyInfo.forum_rating}';		

	$("option").each(function(i,obj){
		if(forum_rating === $(obj).val()){
...
$(".update_btn").on("click", function(e){
	...
	const forum_replyId = '${replyInfo.forum_replyId}';
