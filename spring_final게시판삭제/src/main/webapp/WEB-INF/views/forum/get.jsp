...
<%@include file="../includes/header2.jsp" %>
	...
	<article class="post">
								<header>
									...
									<div class="meta">
										<time class="published" datetime="2015-10-22">Nomember 15, 2022</time>
										<!--  작성자 -->
								...
								<div class="form_section_content">
									...
									<!--  게시판 내용 -->
								<textarea name="" rows="20" class="board_content" readonly="readonly" ><c:out value="${pageInfo.forum_content}"/></textarea>		
