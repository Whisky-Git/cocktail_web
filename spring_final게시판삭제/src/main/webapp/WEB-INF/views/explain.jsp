...
<body>
	...
	<div class="">
		...
		<!-- 
			...
			<br>
			<font style= " display: flex; justify-content: center; font-family: 'MaplestoryOTFBold'; margin-top:20px; font-weight:lighter; font-size:50px ">칵테일이란?</font><br>
			...
			<div class="f-bg2222" style="display: inline-flex;flex-direction: column; overflow: auto; height: 800px; margin-top:20px">
					<div class="mm222">
					<div class="txc-textbox">
						...
						<div class="imageblock left" style="float: left; margin-right: 10px;">
							<span
								...
								-->
								<img src="../../resources/img/explain.jpg" style=" width:300px; height: 300px;">
							</span>
						...
						<div class="definition" style="font-size:17px">
							<span name="definition1">
								<p  style="text-align:left;">칵테일이란 일반적으로 「여러 가지의 약주, 과즙과 향미 등을 혼합하여 얻은 음료」즉 얼마간의 재료를 서로 섞어 만드는 음료라는 식으로 해석되고 있으나,
					   		...
					   		<span name="definition2">
					   			<p  style="text-align:left;">따라서 현재 칵테일이란 넓은 의미와 좁은 의미로 쓰여지고 있다. 즉 넓은 의미의 칵테일은 혼합 음료의 모두를 가리켜 믹스․드링크(mixed drinks)라 말하고
					   		...
					   		<p  style="text-align:left;">실버․셰이커(silver shaker)가 얼음덩이와 같이 흔들리는 소리와 박자,
					   		...
					   		<div class="history">
								...
								<br><br>
					   				<div class="history1" >
										...
										<p  style="text-align:left;">	술은 여러 가지의 재료를 서로 섞어서 마신다고 하는 생각은 벌써 오랜 시대부터 전해 왔지만, 
										...
										<br><br>
										<span>
										<p  style="text-align:left;">이와 같이 믹스.드링크(mixed drink)의 역사는 지극히 오래된 것이지만 현재 마시고 있는 칵테일의 형태는 아마 오랜뒤에서부터 만들어졌을 것이다.왜냐하면 지금의 칵테일은 인조 얼음이 첨가되기 때문이다.
										...
										<br><br>
										<span>
										   <p  style="text-align:left;">그 후 칵테일은 급속히 세계에 파급되어 1855년에 출판된 영국의 작가 삿카레의 소설《New Comes》에 “대위, 당신은 브랜디․칵테일을 마신 적이 있습니까”라는 구절이 나와 있기도 하였다. 그러나 뭐니뭐니 해도 세계 제1차 대전과 미국의 금주법에 의해서 미주 지역은 물론 유럽에까지 칵테일이 널리 보급되기에 이르렀다.
										</p></span>
										<br><br>
					   				</div>
					   				<br><br>
					   				...
					   				<br><br>
					   				<span style="float: left;"><p  style="text-align:left;">
					   				&nbsp;&nbsp;
					   				칵테일의 유래는 여러 가지 설이 있지만 그 중에서도 몇 가지의 전설은 널리 알려지고 있다.</p></span>
					   				<br><br>
					   				<span>
										<p  style="text-align:left;">① 멕시코만 유카탄 반도의 칸베체라고 하는 옛날 항구에 영국의 배가 짐을 실으로 입항하게 되었다.
					   				...
					   				<br><br>
					   				<span>
					   				  <p  style="text-align:left;"> ② 1779년 미국의 한 마을에서  조용한 여관을 경영하고 있는 「짐」이라는 남자가 살고 있었다. 그는 귀여운 딸 하나와 싸움 잘하는 투계 한 마리를 가진 자로서 자만심이 누구보다도 강한 사람이었다.
					   				...
					   				<br><br>
					   				<span>
					   					<p  style="text-align:left;">③ 독립전쟁이 한창인 때 지금의 뉴욕의 북쪽에 「엠스훠트」라고 하는 영국 식민지가 있었다.여기에서「벳치․후라나컨」이란 미녀가 조그만 바아(bar)를 경영하고 있었다.
					   					 그녀는 독립의 기상이 높은 장병들에게 동경의 대상이었다. 
					   				</p></span>
					   				<span>
									<p  style="text-align:left;">전쟁이 승리로 끝난 어느 날 밤,
