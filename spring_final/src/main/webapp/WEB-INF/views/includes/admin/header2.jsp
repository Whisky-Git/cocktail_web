 ...
 <div id="header-row">
	   ...
	   <div class="container my-div">			
			 ...
			 <ul class="nav"  style="font-size:15px;" >
                        <li><a href="main"  style="color:#000;"><b>칵테일 설명</b></a></li>
                        <li><a href="../cocktailList" style="color:#000;"><b>레시피</b></a></li>
                        <li><a href="../service.html" style="color:#000;"><b>자유게시판</b></a></li>
                        <li><a href="blog.html" style="color:#000;"><b>top100</b></a></li>									
                    </ul>						
			  </form>
