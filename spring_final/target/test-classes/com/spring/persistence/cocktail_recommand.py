...
cocktail_recipe = pd.read_csv('C:/Users/User/Desktop/영주/final/db관련/cocktail_recipe.csv')
...
# 21세기 칵테일과 비슷한 칵테일 n개 추천
a = find_simi_cocktail_name(cocktail_recipe, cocktail_simi_co_sorted_ind, '갓파더', 3) 
print(a)

a.to_csv("C:/Users/User/Desktop/영주/final/test/weneed.csv", encoding='euc-kr')
